...
export default function MobileSidebar() {
  ...
  return (
    <>
      ...
      <header className="  z-40  flex h-14 items-center justify-between border-b border-zinc-400 shadow shadow-black/50 bg-white pl-4 dark:border-zinc-800 dark:bg-zinc-900 lg:hidden duration-200">
        ...
        {open && (
          <>
            ...
            >
              ...
              <div className="h-13 flex justify-between items-center border-b border-zinc-200 px-5 dark:border-zinc-800">
