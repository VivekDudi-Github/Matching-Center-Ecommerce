      ...
      >
        <div className="relative md:h-64 h-36 w-full overflow-hidden rounded-md inline-block bg-stone-100">
         ...
         <div className="md:mt-4 mt-1 px-1 pb-1">
          {/* Title */}
          <div>
            <div className=" bg-slate-500 dark:bg-white/80 animate-pulse rounded-md h-4 w-12 duration-300 "/> 
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="flex gap-0.5 md:text-xl text-[12px] font-bold dark:text-zinc-100 text-black -ml-1">
                    <div className="w-4 h-6 bg-slate-600 dark:bg-white/80 animate-pulse rounded-md"/>
                    <div className="w-2 h-6 bg-slate-600 dark:bg-white/80 animate-pulse rounded-md"/>
